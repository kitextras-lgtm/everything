                ...
                <div className="rounded-2xl p-1 shadow-xl" style={{ backgroundColor: '#1a1a1e' }}>
                  <nav className="space-y-1 p-2">
                    <button
                      ...
                      style={{
                        backgroundColor: settingsSection === 'personal' ? '#0f0f13' : 'transparent',
                        color: '#F8FAFC'
                      }}
                    >
                      Personal info
                    ...
                    <button
                      ...
                      style={{
                        backgroundColor: settingsSection === 'accounts' ? '#0f0f13' : 'transparent',
                        color: '#F8FAFC'
                      }}
                    >
                      Connected accounts
                    ...
                    <button
                      ...
                      style={{
                        backgroundColor: settingsSection === 'payout' ? '#0f0f13' : 'transparent',
                        color: '#F8FAFC'
                      }}
                    >
                      Payout methods
                    ...
                    <button
                      ...
                      style={{
                        backgroundColor: settingsSection === 'notifications' ? '#0f0f13' : 'transparent',
                        color: '#F8FAFC'
                      }}
                    >
                      Notifications
