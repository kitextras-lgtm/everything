  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto relative z-10">
        <div className={`mb-12 md:mb-20 transition-all duration-1000 ${sectionVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
...
function ServiceCard({ service, index, isVisible: parentVisible }: { service: ServiceCard; index: number; isVisible: boolean }) {
  const { ref, isVisible: scrollVisible } = useScrollAnimation();
  const shouldShow = scrollVisible && parentVisible;
